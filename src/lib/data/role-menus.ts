...
const commercial = [{ label: "Leads e contactos", href: "/app/contactos" }, { label: "CRM Meta + TikTok", href: "/app/meta" }, { label: "Agenda", href: "/app/agenda" }];
...
export function menuForRole(role: RoleKey): RoleMenuGroup[] {
  if (role === "superadmin") return [{ title: "Supervisão global", items: [{ label: "Website público", href: "/admin/website" }, { label: "Leads Meta + TikTok", href: "/app/meta" }, { label: "Mapa do sistema", href: "/admin/mapa-sistema" }, { label: "Auditoria", href: "/admin/auditoria" }, { label: "Permissões", href: "/admin/permissoes" }] }];
  ...
  if (role === "marketing") return [{ title: "Marketing", items: [{ label: "Campanhas", href: "/app/x-campaigns" }, { label: "Leads Meta + TikTok", href: "/app/meta" }, { label: "Relatórios", href: "/app/observabilidade" }] }];
