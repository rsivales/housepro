      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4">
        {ACTIONS.map((a) => (
          <Link
            key={a.label}
            href={a.href}
            className="group flex items-center gap-3 rounded-2xl border bg-card px-4 py-4 shadow-sm transition-shadow hover:shadow-md sm:gap-4 sm:px-5 sm:py-5"
          >
            <span className="grid size-11 shrink-0 place-items-center rounded-xl" style={{ background: "var(--secondary)", color: "var(--hp-navy)" }}>
