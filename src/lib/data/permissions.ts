...
export const ROLE_LABEL: Record<RoleKey, string> = {
  admin: "Administração (marca)",
  coordenador: "Coordenação (agência)",
  agente: "Agente",
  agente_ami: "Agente com AMI próprio",
};

export const ROLE_ORDER: RoleKey[] = ["admin", "coordenador", "agente_ami", "agente"];
...
export const ROLE_CAPS: Record<RoleKey, Record<string, boolean>> = {
  ...
  coordenador: {
    ...
    view_all_agencies: false, // apenas a sua agência
  },
  agente_ami: {
    view_commissions: true,
