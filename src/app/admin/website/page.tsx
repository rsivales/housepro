...
const CARDS = [
  ...
  { href: "/admin/website/media", icon: Image, title: "Fotografias das landing pages", note: "Heróis, banners e imagens promocionais de todas as páginas públicas" },
  {
    ...
    icon: Images,
    title: "Banners do hero",
    note: "Imagem, título, botões, prioridade, datas e ativação",
  },
  {
    href: "/admin/website/historias",
    icon: Clapperboard,
    title: "Histórias reais",
    note: "Registo de consentimento · só publica com autorização",
  },
  {
    href: "/admin/website/vagas",
    icon: Briefcase,
    title: "Vagas (carreiras)",
    note: "Criar, editar, ativar/desativar oportunidades",
  },
  {
    href: "/admin/website/artigos",
    icon: Newspaper,
    title: "Imagens de artigos",
    note: "Definir a imagem de destaque de cada artigo do Guia",
  },
  {
    href: "/admin/website/conhecer-housepro",
    icon: PanelTop,
    title: "Banner Conhecer a HousePro",
    note: "Imagem, texto e ligação do banner da homepage",
  },
  {
    href: "/admin/website/signature",
    icon: PanelTop,
    title: "Banner HousePro Signature",
    note: "Fotografia, texto, alt text e ligação do destaque Signature",
  },
];
      ...
      <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
        ...
        <div className="mt-6 rounded-2xl border border-amber-500/40 bg-amber-500/5 p-4 text-sm">
          ...
          <p className="mt-1 text-muted-foreground">
            A secção “Confiança reconhecida” mostra apenas distinções reais e
            verificáveis. O selo DECO PROteste <strong>não</strong> é
            apresentado enquanto não houver atribuição e autorização oficiais
            (nem selo, nem nome, nem placeholder público). Novos selos só devem
            ser ativados após aprovação, ficheiro, validade e link de
            verificação.
          </p>
        </div>
